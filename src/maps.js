      ...
      },
      {
        ...
        paint: {
          ...
          'line-color': ['interpolate', ['linear'], ['get', 'w'],
            0,    ['match', ['get', 'div'],
              '1',  '#183c16',  '2a', '#143217',  '2b', '#163f2c',
              '3',  '#0b4340',  '4',  '#504010',  '5',  '#664118',
              '6',  '#57231c',  '7',  '#584324',  '8',  '#522913',
              '9',  '#3e2f13',  '10', '#524c0d',  '11', '#56522a',
              '12', '#3a491a',  '#141414'],
            0.1,  ['match', ['get', 'div'],
              '1',  '#1f4b1c',  '2a', '#193f1d',  '2b', '#1c4f38',
              '3',  '#0e5451',  '4',  '#645014',  '5',  '#7f511e',
              '6',  '#6d2c24',  '7',  '#6e542e',  '8',  '#663418',
              '9',  '#4e3b18',  '10', '#675f10',  '11', '#6b6735',
              '12', '#495c21',  '#191919'],
            0.5,  ['match', ['get', 'div'],
          ...
          'line-width': [
            'interpolate', ['linear'], ['zoom'],
            3,  ['interpolate', ['linear'], ['get', 'w'], 0, 0.25, 0.001, 0.4,  0.01, 0.5,  0.1, 0.9,  1.0, 1.2],
            5,  ['interpolate', ['linear'], ['get', 'w'], 0, 0.5,  0.001, 0.75, 0.01, 1.2,  0.1, 1.8,  1.0, 2.5],
            7,  ['interpolate', ['linear'], ['get', 'w'], 0, 0.7,  0.001, 1.2,  0.01, 1.7,  0.1, 2.9,  1.0, 4.0],
            8,  ['interpolate', ['linear'], ['get', 'w'], 0, 1.0,  0.001, 1.8,  0.01, 2.5,  0.1, 4.8,  1.0, 6.8],
            9,  ['interpolate', ['linear'], ['get', 'w'], 0, 1.5,  0.001, 2.6,  0.01, 4.5,  0.1, 8.2,  1.0, 11.7],
            ...
            14, ['interpolate', ['linear'], ['get', 'w'], 0, 7.0,  0.001, 18.0, 0.01, 58.0, 0.1, 58.0, 1.0, 85.0],
          ],
          'line-opacity': 1.0,
          'line-blur': 0,
        },
