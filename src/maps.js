    ...
    layers: [
      {
        ...
        paint: {
          ...
          'line-width': [
            ...
            3, ['step', ['get', 'w'], 1.5, 0.001, 3.0, 0.05, 8.0],
            8, ['step', ['get', 'w'], 2.5, 0.001, 5.0, 0.05, 14.0],
            12, ['step', ['get', 'w'], 4.0, 0.001, 8.0, 0.05, 22.0],
          ],
          'line-opacity': ['step', ['get', 'w'], 0.06, 0.001, 0.12, 0.05, 0.22],
          'line-blur': 4,
        },
      },
      {
        ...
        paint: {
          ...
          'line-width': [
            'interpolate', ['linear'], ['zoom'],
            3, ['step', ['get', 'w'], 0.4, 0.001, 0.9, 0.05, 2.2],
            8, ['step', ['get', 'w'], 0.8, 0.001, 1.8, 0.05, 5.0],
            12, ['step', ['get', 'w'], 1.2, 0.001, 3.0, 0.05, 9.0],
          ],
          'line-opacity': ['step', ['get', 'w'], 0.5, 0.001, 0.7, 0.05, 0.95],
        },
      },
    ],
  },
