...
export const ATLAS_MAPS = [
  ...
  },
  {
    ...
    story: 'Australia has experienced some of the world\'s most devastating wildfires. The 1974–75 season burnt an estimated 117 million hectares — possibly the largest fire extent in recorded history. The 2002 NT season scorched vast tracts of Northern Territory. The 2009 Black Saturday fires killed 173 people in Victoria in a single day. The 2019–20 Black Summer burnt 18.6 million hectares and killed an estimated 3 billion animals. Use the year selector to explore each season.',
    noStateFills: true,
    initialZoom: 4.0,
    fireYears: [
      { id: '2019', label: '2019–20 Black Summer', colour: '#c0392b' },
      { id: '2009', label: '2009 Black Saturday',  colour: '#8e44ad' },
      { id: '2002', label: '2002 NT Season',        colour: '#e74c3c' },
      { id: '1974', label: '1974–75 Season',        colour: '#e67e22' },
    ],
    palette: {
      background: '#0d0800',
      fill: ['#c0392b'],
