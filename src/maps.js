...
export const ATLAS_MAPS = [
  {
    ...
    sources: [
      ...
      {
        id: 'lakes',
        spec: { type: 'geojson', data: './lakes.geojson' },
      },
    ],
    layers: [
      {
        ...
        source: 'lakes',
        paint: {
          'fill-color': ['match', ['get', 'div'],
            '1',  '#164013',  '2a', '#164f35',  '2b', '#0d5451',
            '3',  '#0d5451',  '4',  '#4c3d0f',  '5',  '#5f472b',
            '6',  '#60241c',  '7',  '#604827',  '8',  '#5f2f15',
            '9',  '#523d16',  '10', '#50470d',  '11', '#514e28',
            '12', '#3c4c19',  '#444'],
          'fill-opacity': 0.25,
        },
      },

      {
        ...
        paint: {
          ...
          'line-opacity': ['interpolate', ['linear'], ['zoom'],
            3, ['interpolate', ['linear'], ['get', 'w'], 0, 0.20, 0.001, 0.45, 0.05, 0.65, 2.0, 0.85],
            6, ['interpolate', ['linear'], ['get', 'w'], 0, 0.20, 0.001, 0.45, 0.05, 0.65, 2.0, 0.85],
            9, 0,
          ],
        },
      },
        ...
        paint: {
          ...
          'line-color': ['interpolate', ['linear'], ['get', 'w'],
            0,    ['match', ['get', 'div'],
              ...
              '12', '#3c4c19',  '#141414'],
            0.1,  ['match', ['get', 'div'],
              '1',  '#1b5118',  '2a', '#1b6443',  '2b', '#116b66',
              '3',  '#116b66',  '4',  '#604d13',  '5',  '#785937',
              '6',  '#792e24',  '7',  '#795c31',  '8',  '#783c1b',
              '9',  '#684d1c',  '10', '#655a11',  '11', '#676232',
              '12', '#4c6020',  '#191919'],
            0.5,  ['match', ['get', 'div'],
              '1',  '#3aaa33',  '2a', '#3ad28c',  '2b', '#24dfd6',
              '3',  '#24dfd6',  '4',  '#c8a128',  '5',  '#fbbb73',
              '6',  '#fd614c',  '7',  '#fec067',  '8',  '#fb7d39',
              '9',  '#d9a13c',  '10', '#d3bc24',  '11', '#d7ce6a',
              '12', '#9fca43',  '#333333'],
          ],
          'line-width': [
            'interpolate', ['linear'], ['zoom'],
            3,  ['interpolate', ['linear'], ['get', 'w'], 0, 0.3,  0.001, 0.45, 0.01, 0.6,  0.1, 0.9,  1.0, 1.2],
            5,  ['interpolate', ['linear'], ['get', 'w'], 0, 0.4,  0.001, 0.75, 0.01, 1.1,  0.1, 1.8,  1.0, 2.5],
            7,  ['interpolate', ['linear'], ['get', 'w'], 0, 0.5,  0.001, 0.95, 0.01, 1.5,  0.1, 2.8,  1.0, 4.0],
            8,  ['interpolate', ['linear'], ['get', 'w'], 0, 0.8,  0.001, 1.5,  0.01, 2.5,  0.1, 4.8,  1.0, 6.8],
            9,  ['interpolate', ['linear'], ['get', 'w'], 0, 1.3,  0.001, 2.6,  0.01, 4.5,  0.1, 8.2,  1.0, 11.7],
            10, ['interpolate', ['linear'], ['get', 'w'], 0, 2.0,  0.001, 4.5,  0.01, 8.0,  0.1, 14.0, 1.0, 20.0],
...

  {
    ...
    category: 'base',
    title: 'Backdrop (Dark)',
    subtitle: 'MapTiler — inverted reference map',
    story: 'The Backdrop basemap with colours inverted — all the same detail and road networks but rendered as a dark map, ideal for night viewing or overlaying bright data layers.',
    palette: { background: '#171820', fill: ['#2b2a30'], stroke: '#605860', text: '#c5cad5' },
    noStateFills: true,
    baseStyle: `https://api.maptiler.com/maps/backdrop/style.json?key=${MT}`,
